const HomeScreenFAQData = [
  ...
  {
    label: "What if you can't fix my issue?",
    desc: "In the rare event we cannot resolve your issue during the initial service period, you won't be charged for that time. We'll either recommend alternative solutions (like hardware replacement) or escalate to our senior technicians at no additional diagnostic cost. Our satisfaction guarantee means you only pay for successful resolutions.",
    expanded: false,
  },
  {
    label: "Do you provide business IT support?",
    desc: "Yes! We offer specialized small business support packages that include priority response, onsite visits, network monitoring, and preventative maintenance. Our business plans start at $299/month for up to 5 devices with discounts for larger deployments. Contact our business solutions team for a custom quote.",
    expanded: false,
  },
  {
    label: "What information do you need from me?",
    desc: "For most issues, we'll need: device make/model, operating system version, description of the problem, steps already attempted, and any error messages. For remote access, we use secure enterprise-grade software that requires your explicit permission for each session. You'll be able to monitor all technician activity and terminate the session anytime.",
    expanded: false,
  },
  {
    label: "How quickly can you help with urgent issues?",
...
export { HomeScreenFAQData, HomeScreenFAQDataEs };
