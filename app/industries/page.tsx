...
export default function Industries() {
  ...
  return (
    <>
      {/* Hero section */}
      <section className="flex md:flex-row flex-col h-auto py-5 px-4 align-center bg-gradient-to-r from-slate-200 via-sky-100 to-indigo-300 shadow-md  mb-0 sm:px-6 xl:px-40 md:px-10 py-10 px-4" style={{ alignItems: "center" }}>
        <div className="w-full lg:pe-4">
          <div className="flex flex-col md:flex-row gap-4 w-full">
          
            <div className="w-full h-full lg:py-16 flex rounded-4xl md:w-3/5 order-1 md:order-1 xl:order-2" data-aos="fade-left" data-aos-delay="200">
                <img
              ...
              <div className="flex flex-col justify-center items-center w-full md:w-2/5 relative h-[inherit] xl-order-2" data-aos="fade-right" data-aos-delay="200">
              <Typography
      ...
      {/* Our Core IT Support Service section */}
